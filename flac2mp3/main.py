...
def flac_thread(flac_list, input_dir, output_dir, flac_count, theads_count, overwrite, bar):
...
def main():
    ...
    if os.path.isfile(input_path):
        ...
        with alive_bar(flac_total, title="Processing flac files:", bar="notes", spinner_length=5, receipt=False, elapsed=False, stats=None) as bar:
            flac_thread(flac_list, input_path, output_path, flac_count, thread_count, overwrite, bar)
